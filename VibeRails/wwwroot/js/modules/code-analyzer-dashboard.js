...
/**
 * Renders the legacy Code Quality workspace (changed files | metrics | source) and
 * returns the number of files shown. No screen mounts it any more: Project health
 * renders the Code Atlas / Quality Lab viewer (code-report/viewer.js) inline.
