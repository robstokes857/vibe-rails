...
public sealed class LlmParser : ILlmParser
{
    ...
    // explicitly here. All three launch `opencode` with a pinned --model flag (see
    ...
    // "glm-5.2" / "grok-4.6" / "glm-5.3" for the pseudo-CLIs, the canonical enum name otherwise. Every outbound
