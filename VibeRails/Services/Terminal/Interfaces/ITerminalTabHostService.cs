...
public interface ITerminalTabHostService
{
    ...
    Task<TabTokenSaverStateResponse> GetTokenSaverStateAsync(string tabId, CancellationToken cancellationToken = default);
    Task<TabTokenSaverStateResponse> SetTokenSaverStateAsync(string tabId, bool enabled, CancellationToken cancellationToken = default);
