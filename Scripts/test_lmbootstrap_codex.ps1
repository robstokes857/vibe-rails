# test-lmbootstrap-codex.ps1 - Build and test Codex LMBootstrap mode
...
Write-Host "Launching Codex in LMBootstrap mode..." -ForegroundColor Cyan
& $exe --lmbootstrap codex
