...
namespace Tests.Services.VCA
{
    public class PackageChangeValidatorTests
    {
        ...
        public async Task ValidateAsync_WhenNotPackageFile_ShouldPass()
        {
            ...
            // Act
            var result = await _validator.ValidateAsync("MyClass.cs", rule, "vc.rules.md", "/root", null, CancellationToken.None);
        ...
        public async Task ValidateAsync_WhenPackageFile_ShouldFail()
        {
            ...
            // Act
            var result = await _validator.ValidateAsync("package.json", rule, "vc.rules.md", "/root", null, CancellationToken.None);
        ...
        public async Task ValidateAsync_WithVariousPackageFiles_ShouldFail(string fileName)
        {
            ...
            // Act
            var result = await _validator.ValidateAsync(fileName, rule, "vc.rules.md", "/root", null, CancellationToken.None);
